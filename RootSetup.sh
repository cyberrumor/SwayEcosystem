...
pacman -S xdg-user-dirs ufw sway xorg-server-xwayland termite swaylock swayidle python-pywal grim intel-ucode light neofetch fzf pulseaudio pulseaudio-alsa imagemagick mako bemenu waybar ttf-ubuntu-font-family archlinux-wallpaper linux-lts
